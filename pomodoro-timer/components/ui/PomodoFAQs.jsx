...
export default function PomodoroFaq() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8 bg-white dark:bg-black">
      <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-6 sm:mb-8 md:mb-10 text-black dark:text-white transition-all duration-300 hover:scale-105">
